...
def baseline_model():
    model = Sequential()
    model.add(Dense(24, input_dim=dataset.shape[1]-2, activation='sigmoid'))
...
estimator = KerasClassifier(build_fn=baseline_model, nb_epoch=20000, batch_size=5, verbose=0)
